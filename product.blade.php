                ...
                <div class="row">
                    <div class="col-md-4 text-center animate-box">
                        <div class="product">
                            ...
                            <div class="desc">
                                <h3><a href=<?= url('single'); ?>>Hauteville Concrete Rocking Chair</a></h3>
                ...
                <div class="row">
                    <div class="col-md-4 text-center animate-box">
                        <div class="product">
                            ...
                            <div class="desc">
                                <h3><a href=<?= url('single'); ?>>The WW Chair</a></h3>
                    ...
                    <div class="col-md-4 text-center animate-box">
                        <div class="product">
                            ...
                            <div class="desc">
                                <h3><a href=<?= url('single'); ?>>Himitsu Money Box</a></h3>
                    ...
                    <div class="col-md-4 text-center animate-box">
                        <div class="product">
                            ...
                            <div class="desc">
                                <h3><a href=<?= url('single'); ?>>Ariane Prin</a></h3>
